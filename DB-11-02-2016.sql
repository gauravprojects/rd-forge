...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 10, 2016 at 08:35 PM
...
`id` int(10) NOT NULL,
  ...
  `raw_material_type` varchar(10) NOT NULL,
  `total_weight` int(10) NOT NULL,
  `available_weight` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 'admin', '$2a$10$CuHKyEbvKAt06kAgITp9IegTq/kMePhbDS56eZiKmOe.p9vMam.HK', 'xz53lnJ1KvFy003BrqHmSbHLo4UkkyjC2ecp6znkg1mASrZggiWIYtnhzMHl', '2016-02-08 09:19:39', 1),
