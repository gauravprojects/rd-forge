                ...
                <div class="card">
                    ...
                    <div class="row" id="right-col">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('schedule',null,array('class'=>'form-control','placeholder'=>'Schedule name','id'=>'anything')) }}
                        </div>

                        <div class="loginButton">

                            {{ Form::submit('Add Schedules',array('class'=>'waves-effect waves-light btn col-xs-12 col-sm-12 col-md-12 col-lg-12 teal button')) }}
                        </div>
                        {{ Form::close() }}
                    </div>
