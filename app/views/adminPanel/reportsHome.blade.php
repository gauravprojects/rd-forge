        ...
        <div class="row">
            <div class="wrapper">
                <div class="card">
                    ...
                    <a href="<?php  echo route('machining.report'); ?> " class="col-xs-12 col-sm-12 col-md-12 col-lg-12 waves-effect waves-light btn link">Machining Material reports</a><br><br>
