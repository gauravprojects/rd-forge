...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 25, 2015 at 09:11 AM
...
(8, '12456', '2015-12-09', '50x40', 'RD-Forge', '1234589', 46463, '', '', '1970-01-01', '', '1970-01-01', 'SSSH', 'Round', 46463);
...
--
ALTER TABLE `drilling_records`
  MODIFY `drilling_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `seration_records`
  MODIFY `seration_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `work_order_details`
  MODIFY `work_order_no` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `work_order_material_details`
--
ALTER TABLE `work_order_material_details`
  MODIFY `work_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
